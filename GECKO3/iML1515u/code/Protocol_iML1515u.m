...
adapterLocation = '~/CORAL/GECKO3/iML1515u/iML1515uAdapter.m';
...
% saveEcModel(ecModel,'eciML1515u_stage1.yml');

%% STAGE 2: integration of kcat into the ecModel structure
% ecModel = loadEcModel('eciML1515_underground_stage1.yml'); 
...
ecModel_DLKcat.subSystems = getSubSystem_str(ecModel_DLKcat);
...
saveEcModel(ecModel_DLKcat,'eciML1515u_v2_stage2_DLKcat.yml');
saveEcModel(ecModel_Merged,'eciML1515u_v2_stage2_Merged.yml');

%% STAGE 3: model tuning
% ecModel = loadEcModel('eciML1515u_v2_stage2_DLKcat.yml', ModelAdapter); 
...
% saveEcModel(ecModel,'eciML1515u_v2_stage3.yml');