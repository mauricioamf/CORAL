function [solution1, solution2, solution3] = testEcoliModels_iJO1366(ecModel, verbose)
%
...
% Carbon sources
model_temp = changeRxnBounds(model_temp, 'EX_glc_e', -10, 'l'); %D-glucose
...
model_temp.c(:) = 0;
model_temp = changeObjective(model_temp, 'Ec_biomass_iJO1366_core_53p95M', 1);
...
model_temp.c(:) = 0;
model_temp = changeObjective(model_temp, 'Ec_biomass_iJO1366_core_53p95M', 1);
model_temp = changeRxnBounds(model_temp, 'Ec_biomass_iJO1366_core_53p95M', 0.1, 'b'); 
