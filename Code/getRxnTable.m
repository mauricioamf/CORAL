function combinedTable = getRxnTable(ecModel, rxnsInd, substrateMets, productMets, substrateCoeffs, productCoeffs)
%
...
%
%   Outputs
%       combinedTable                 (table) a table combining all inputs
%
% .. Author:
